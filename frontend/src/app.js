...
function renderPlanTable() {
  ...
  const rowsHtml = state.planRows.map((row, index) => {
    ...
    return `<tr>
      ...
      <td style="vertical-align:middle; padding:12px 8px;"><button class="secondary" data-action="remove-plan-row" data-plan-index="${index}" style="padding:6px 14px; margin:0; font-size:15px; height:38px; font-weight:600;">刪除</button></td>
    </tr>`;
  }).join("");
  ...
  return `
    ...
    <div class="table-wrap"><table style="font-size:16px;">
      <thead>
        <tr>
          <th style="font-size:16px; padding:10px 8px; width:25%; min-width:320px; vertical-align:middle;">題型</th>
          <th style="font-size:16px; padding:10px 8px; width:10%; min-width:100px; vertical-align:middle;">題數</th>
          <th style="font-size:16px; padding:10px 8px; width:53%; min-width:680px; vertical-align:middle;">每題(答)配分</th>
          <th style="font-size:16px; padding:10px 8px; width:8%; min-width:80px; vertical-align:middle;">小計</th>
          <th style="font-size:16px; padding:10px 8px; width:4%; min-width:60px; vertical-align:middle;"></th>
        </tr>
      </thead>
